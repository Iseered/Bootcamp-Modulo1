...
public class SistemaCalificaciones {
    ...
    public static void main (String[] args){
        ...
        System.out.println("La nota mas alta y minima es :"
        +max+","+min);

        //buscar un elemnto
        System.out.println("La nota de 18.0 existeen mi lista?" +
                calificaciones.contains(18.0));
       ...
       //SETS
        ...
        System.out.println("La edad de paual es " + edades.get("Paula"));
